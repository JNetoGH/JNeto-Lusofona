...
class SpriteObject:
    ...
    def __init__(self, game, path="resources/sprites/static_sprites/candlebra.png", pos=(10.5, 3.5), scale=0.7, height_shift=0.27):
        self.game = game
    ...
    def get_sprite(self):
        ...
        if -self.IMAGE_HALF_WIDTH < self.screen_x < (settings.SCREEN_WIDTH + self.IMAGE_HALF_WIDTH) and self.normal_dis > 0.5:
